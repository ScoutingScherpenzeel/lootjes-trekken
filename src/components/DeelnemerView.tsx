						...
						<AnimatePresence mode="wait">
							{!revealed ? (
								<motion.div
									...
									className="space-y-8"
								>
									<div className="mx-auto flex h-50 w-50 items-center justify-center rounded-full border-8 border-yellow-400 bg-black">
								...
								>
									...
									>
										...
										<span className="absolute bottom-2 left-4 text-3xl opacity-40" aria-hidden="true">
											⭐
										</span>
										<p className="text-sm font-black uppercase tracking-[0.4em] text-yellow-200">Jij hebt getrokken:</p>
